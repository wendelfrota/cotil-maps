/*function ativarDiv(divId) {  
  ...
  document.getElementById("form").addEventListener("submit", function(event) {
    ...
    if (saida === "academico" && chegada === "administrativo"){
      removeOn();
      addImg();
      document.getElementById("rota-1").style.cssText = "width: 62px; top: 273px; left: 56px;"
      ...
      rotaImg.style.cssText = "position: absolute; left: 99px; top: 246px; z-index: 99999;"
      ...
      removeOn();
      addImg();
      document.getElementById("rota-1").style.cssText = "width: 80px; top: 194px; left: 56px;"
      document.getElementById("rota-2").style.cssText = "width: 2px; top: 148px; left: 136px; height: 45px; border-left: 4px dotted black;"
      ...
      rotaImg.style.cssText = "position: absolute; left: 37px; top: 167px; z-index: 99999;"
  
  
    } else if (saida === "administrativo" && chegada === "restaurante universitario") {
      removeOn();
      addImg();
      document.getElementById("rota-1").style.cssText = "width: 2px; top: 159px; left: 136px; height: 118px; border-left: 4px dotted black;"
      ...
      removeOn();
      addImg();
      document.getElementById("rota-1").style.cssText = "width: 112px; top: 273px; left: 56px;"
      ...
      removeOn();
      addImg();
      document.getElementById("rota-1").style.cssText = "width: 2px; top: 385px; left: 460px; height: 94px; border-left: black dotted 4px;"
      document.getElementById("resultado").innerText = "."
      rotaImg.style.cssText = "position: absolute; left: 444px; top: 358px; z-index: 99999;"
